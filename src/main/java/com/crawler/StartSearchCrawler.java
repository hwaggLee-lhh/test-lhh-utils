...
public class StartSearchCrawler implements Runnable {
	...
	public static void main(String[] args) {
		...
		StartSearchCrawler crawler = new StartSearchCrawler(args[0], max,args[2]);
	...
	public StartSearchCrawler(String startUrl, int maxUrl, String searchString) {
